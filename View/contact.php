        ...
        <div class="container">
          ...
          <div class="collapse navbar-collapse" id="navbarResponsive">
            <ul class="navbar-nav ml-auto">
                ...
                <li class="nav-item active"><a class="nav-link" href="contact.php">Contacter nous</a></li>
...
-->
          ...
          <div class="col-md-4">
            <div class="left-content">
              <h4>A propos notre office </h4>
              <p> une description pour l'office</p>
