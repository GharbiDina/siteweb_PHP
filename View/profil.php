          ...
          <div class="collapse navbar-collapse" id="navbarResponsive">
            <ul class="navbar-nav ml-auto">
               <!-- <li class="nav-item">
                ...
                <li class="nav-item active"><a class="nav-link" href="profil.phpid=<?php echo $_SESSION['id']; ?>">Voitures</a></li>
        ...
        <div class="row">
          <div class="col-md-12">
            <div class="text-content">
              <h4>Bienvenue dans notre univers où la passion prend vie Notre cher client</h4>
              
              <h2> <?php echo $userinfo['lastName'];echo $userinfo['firstName']; ?></h2>
            </div>
          </div>
        </div>
      </div>
